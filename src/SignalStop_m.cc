...
SignalStop::SignalStop(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    this->txAddress = 0;
}

SignalStop::SignalStop(const SignalStop& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
{
    this->txAddress = other.txAddress;
}

void SignalStop::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->txAddress);
}

void SignalStop::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->txAddress);
}

int SignalStop::getTxAddress() const
{
    return this->txAddress;
}

void SignalStop::setTxAddress(int txAddress)
{
...
SignalStopDescriptor::SignalStopDescriptor() : omnetpp::cClassDescriptor("SignalStop", "omnetpp::cMessage")
{
...
int SignalStopDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "txAddress")==0) return base+0;
...
std::string SignalStopDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    SignalStop *pp = (SignalStop *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getTxAddress());
        default: return "";
    }
}
...
bool SignalStopDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    SignalStop *pp = (SignalStop *)object; (void)pp;
    switch (field) {
        case 0: pp->setTxAddress(string2long(value)); return true;
