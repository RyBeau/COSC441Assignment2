...
{
    this->receiverAddress = 0;
    this->transmitterAddress = 0;
    this->macPacketType = 0;
}
...
void MacPacket::copy(const MacPacket& other)
{
    ...
    this->macPacketType = other.macPacketType;
}
...
void MacPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->macPacketType);
}
...
void MacPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->macPacketType);
}

int MacPacket::getReceiverAddress() const
{
    return this->receiverAddress;
}

void MacPacket::setReceiverAddress(int receiverAddress)
{
    this->receiverAddress = receiverAddress;
}

int MacPacket::getTransmitterAddress() const
{
    return this->transmitterAddress;
}

void MacPacket::setTransmitterAddress(int transmitterAddress)
{
    this->transmitterAddress = transmitterAddress;
}

int MacPacket::getMacPacketType() const
{
    return this->macPacketType;
}

void MacPacket::setMacPacketType(int macPacketType)
{
    this->macPacketType = macPacketType;
}
...
int MacPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "receiverAddress")==0) return base+0;
    if (fieldName[0]=='t' && strcmp(fieldName, "transmitterAddress")==0) return base+1;
    if (fieldName[0]=='m' && strcmp(fieldName, "macPacketType")==0) return base+2;
...
const char *MacPacketDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "MacPacketType";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string MacPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MacPacket *pp = (MacPacket *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getReceiverAddress());
        case 1: return long2string(pp->getTransmitterAddress());
        case 2: return enum2string(pp->getMacPacketType(), "MacPacketType");
        default: return "";
    }
}
...
bool MacPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MacPacket *pp = (MacPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setReceiverAddress(string2long(value)); return true;
        case 1: pp->setTransmitterAddress(string2long(value)); return true;
        case 2: pp->setMacPacketType((MacPacketType)string2enum(value, "MacPacketType")); return true;
