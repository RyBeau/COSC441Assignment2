...
int SignalStart::getTxAddress() const
{
    return this->txAddress;
}

void SignalStart::setTxAddress(int txAddress)
{
...
int SignalStartDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "txAddress")==0) return base+3;
...
std::string SignalStartDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getTxAddress());
...
bool SignalStartDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setTxAddress(string2long(value)); return true;
